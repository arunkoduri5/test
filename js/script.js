    ...
    try {
        ...
        profileDiv.innerHTML = `
            <div style="text-align: center; margin-bottom: 25px;">
                ...
                <p style="font-size: 14px; font-weight: 600; color: var(--text-muted); letter-spacing: 0.5px; margin-bottom: 5px;">📍 ${userLocation}</p>
...
>>>>>>> 823003280c5454e8985bf3ebca58fb896041f0b3
}